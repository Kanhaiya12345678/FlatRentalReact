...
function OwerRegister() {
    ...
    const handleSubmit = (event) => {
      ...
      axios.post('http://localhost:8081/owner_register', formData)
        .then((result) => {
          navigate('/login');
          swal.fire({
            position: "center",
...
<div className="container mt-5">
      <div className="title">Ower Registration Form</div>
      <form>
