...
function OwnerChangePasword() {
  ...
  const changePassword = (event) => {
    ...
    axios
  .put(
    "http://localhost:8081/owner_changePassword",
    {
  ...
  return (
    <>
      <div className="col-md-12 grid-margin stretch-card" style={{marginLeft:"50px", marginTop:"60px", width:"600px"}}>
          <div className="card">
...
export default OwnerChangePasword
